...
export declare function innerFrom<O extends ObservableInput<any>>(
  input: O
...
export declare function fromAsyncIterable<T>(
  asyncIterable: AsyncIterable<T>
): Observable<T>;
export declare function fromReadableStreamLike<T>(
