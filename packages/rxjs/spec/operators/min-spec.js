...
describe('min', function () {
  ...
  it('should min the values of an observable', function () {
    testScheduler.run(function (_a) {
      ...
      var subs = '      ^----------!';
      var expected = '  -----------(x|)';
      expectObservable(source.pipe(operators_1.min())).toBe(expected, {
        x: -1,
      });
  ...
  it('should work with error', function () {
    testScheduler.run(function (_a) {
      ...
      var e1subs = '   ^--------!';
      var expected = ' ---------#';
      expectObservable(e1.pipe(operators_1.min())).toBe(
        expected,
        null,
        'too bad'
      );
  ...
  it('should allow unsubscribing explicitly and early', function () {
    testScheduler.run(function (_a) {
      ...
      expectObservable(e1.pipe(operators_1.min(predicate)), unsub).toBe(
        expected
      );
      expectSubscriptions(e1.subscriptions).toBe(e1subs);
    });
